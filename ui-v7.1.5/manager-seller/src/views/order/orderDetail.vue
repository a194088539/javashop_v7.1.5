  ...
  <div v-loading="loading" class="order-detail-container">
    ...
    <div class="order-info" v-if="orderDetail">
      ...
      <div class="order-status-info">
        ...
        <div class="opera-btn">
          <el-button type="info" @click="confirmInvoice">打印发货单</el-button>
          ...
          <el-button v-if="isShowCancelOrder && orderDetail.payment_type === 'COD'" plain type="info" @click="cancelDialogShow = true" >取消订单</el-button>
        </div>
      </div>
    </div>
    <!--订单状态 步骤条-->
