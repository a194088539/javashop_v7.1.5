      ...
      <div class="goods-container">
        ...
        <div class="goods-buy">
          <div class="price_wrap">
            <van-cell-group v-if="!hiddenPrice" :border="false" class="price">
    ...
    methods: {
      ...
      handleBuyNow() {
        ...
        API_Trade.buyNow(sku_id, buyNum, this.getActivityId()).then(response => {
          ...
          location.href=`../checkout?way=BUY_NOW`
        })
      },
      /** 拼团买 创建拼团 */
      ...
      toAssembleBuyNow(order) {
        ...
        API_Trade.addToAssembleCart(sku_id, buyNum).then(response => {
          ...
          location.href=`../checkout?order_id=${order.order_id}&from_nav=assemble`
        })
      },
