...
import com.enation.app.javashop.seller.security.SellerAuthenticationFilter;
...
public class SellerSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                }).and().addFilterBefore(new SellerAuthenticationFilter(sellerAuthenticationService), UsernamePasswordAuthenticationFilter.class);
        //禁用缓存
