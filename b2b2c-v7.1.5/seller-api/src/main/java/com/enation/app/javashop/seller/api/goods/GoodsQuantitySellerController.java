...
import com.enation.app.javashop.core.goods.model.dto.GoodsSkuQuantityVO;
...
public class GoodsQuantitySellerController {
	...
	@PutMapping
	public void updateQuantity(@ApiIgnore@Valid @RequestBody List<GoodsSkuQuantityVO>  skuQuantityList, @PathVariable("goods_id")Integer goodsId)  {
