...
public class WayBillVO implements Serializable {
    ...
    public WayBillVO(WayBillPlugin wayBillPlugin) {
        this.id = 0;
        this.name = wayBillPlugin.getPluginName();
        this.open = wayBillPlugin.getOpen();
        this.bean = wayBillPlugin.getPluginId();
        this.configItems = wayBillPlugin.definitionConfigItem();
    }
