...
public class GoodsDO implements Serializable {
	...
	public GoodsDO(GoodsDTO goodsVO) {
		...
		this.goodsName = SensitiveFilter.filter(goodsVO.getGoodsName(), CharacterConstant.WILDCARD_STAR);
	...
	public String toString() {
		return "GoodsDO [goodsId=" + goodsId + ", goodsName=" + goodsName + ", sn=" + sn + ", brandId=" + brandId
				...
				+ ", sellerId=" + sellerId + ", shopCatId=" + shopCatId + ", commentNum=" + commentNum + ", templateId="
				+ templateId + ", goodsTransfeeCharge=" + goodsTransfeeCharge + ", sellerName=" + sellerName
				+ ", isAuth=" + isAuth + ", authMessage=" + authMessage + "]";
	}
