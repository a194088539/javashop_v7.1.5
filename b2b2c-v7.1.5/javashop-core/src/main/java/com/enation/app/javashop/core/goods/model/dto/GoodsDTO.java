...
public class GoodsDTO implements Serializable {
    ...
    public String toString() {
        return "GoodsDTO [goodsId=" + goodsId + ", categoryId=" + categoryId + ", shopCatId=" + shopCatId + ", brandId="
                + brandId + ", goodsName=" + goodsName + ", sn=" + sn + ", price=" + price + ", cost=" + cost
                + ", mktprice=" + mktprice + ", weight=" + weight + ", goodsTransfeeCharge=" + goodsTransfeeCharge
                + ", intro=" + intro + ", haveSpec=" + haveSpec + ", quantity=" + quantity + ", skuList=" + skuList
                + ", goodsParamsList=" + goodsParamsList + ", goodsGalleryList=" + goodsGalleryList + ", exchange="
                + exchange + ", hasChanged=" + hasChanged + ", pageTitle=" + pageTitle + ", metaKeywords="
                + metaKeywords + ", metaDescription=" + metaDescription + ", commentNum=" + commentNum + ", templateId="
                + templateId + ", isAuth=" + isAuth + "]";
    }
