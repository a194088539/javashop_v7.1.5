...
public class DraftGoodsDO implements Serializable {
    ...
    public String toString() {
        return "DraftGoodsDO [draftGoodsId=" + draftGoodsId + ", sn=" + sn + ", goodsName=" + goodsName + ", brandId="
                + brandId + ", categoryId=" + categoryId + ", weight=" + weight + ", intro=" + intro + ", price="
                + price + ", cost=" + cost + ", mktprice=" + mktprice + ", goodsType=" + goodsType + ", haveSpec="
                + haveSpec + ", createTime=" + createTime + ", quantity=" + quantity + ", original=" + original
                + ", sellerId=" + sellerId + ", shopCatId=" + shopCatId + ", templateId=" + templateId
                + ", goodsTransfeeCharge=" + goodsTransfeeCharge + ", sellerName=" + sellerName + ", pageTitle="
                + pageTitle + ", metaKeywords=" + metaKeywords + ", metaDescription=" + metaDescription
                + ", exchangeMoney=" + exchangeMoney + ", exchangePoint=" + exchangePoint + ", exchangeCategoryId="
                + exchangeCategoryId + ", galleryList=" + galleryList + "]";
    }
