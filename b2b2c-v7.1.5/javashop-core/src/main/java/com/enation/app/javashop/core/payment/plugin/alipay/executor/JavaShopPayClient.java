...
public class JavaShopPayClient implements AlipayClient {
    ...
    public <T extends AlipayResponse> T execute(AlipayRequest<T> request, String accessToken,
        ...
        return executeRsp(request, parser, accessToken, appAuthToken);
    }
    ...
    private String getRedirectUrl(RequestParametersHolder requestHolder) throws AlipayApiException {
        ...
        try {
            ...
            if (sign != null & sign.length() > 0) {
                Map<String, String> signMap = new HashMap<String, String>(16);
    ...
    private <T extends AlipayResponse> T executeRsp(AlipayRequest<T> request, AlipayParser<T> parser,
                                                  String authToken,
                                                  String appAuthToken) throws AlipayApiException {
    ...
    private <T extends AlipayResponse> void checkResponseSign(AlipayRequest<T> request,
        ...
        if (!StringUtils.isEmpty(this.alipayPublicKey)) {
            ...
            boolean bool = responseIsSucess || (!responseIsSucess && !StringUtils.isEmpty(signItem.getSign()));
            if (bool) {
