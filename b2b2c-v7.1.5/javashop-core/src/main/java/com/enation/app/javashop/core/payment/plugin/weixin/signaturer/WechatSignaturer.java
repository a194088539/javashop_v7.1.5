...
import com.enation.app.javashop.core.payment.plugin.weixin.exception.WeixinSignatrueExceprion;
import com.enation.app.javashop.core.payment.plugin.weixin.model.WechatDTO;
import com.enation.app.javashop.core.payment.plugin.weixin.signaturer.model.SignatureParams;
import com.enation.app.javashop.core.payment.plugin.weixin.signaturer.model.WechatCgiAccessToken;
import com.enation.app.javashop.core.payment.plugin.weixin.signaturer.model.WechatJsapiTicket;
...
public class WechatSignaturer {
     ...
     * 获取 微信签名 前端调用分享等功能权限
     *
     * @param type @see  com.enation.app.javashop.core.payment.plugin.weixin.signaturer.WechatTypeEnmu
     *             WAP("WAP"),
     *             REACT("原生"),
     *             NATIVE("NAAPP"),
     *             MINI("小程序");
     ...
     * @return
     */
    public Auth2Token getSnsAccessToken() {
        ...
        if (ua.indexOf("micromessenger") > 0) {
            debugger.log("是微信浏览器");
            map = this.getConnectConfig(WechatTypeEnmu.WAP.name());
        } else {
            map = this.getConnectConfig(WechatTypeEnmu.NATIVE.name());
        }
